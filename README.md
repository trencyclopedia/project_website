...
## Brief introduction
Here is my personal website project. Based on GitHub pages, I build up my first website hosting topics and projects that fascinate me. I would very much like to broaden my horizen and sharpen my skills in the digital world. 
...
this website is set up based on Jekyll and GitHub pages techniques which can automatically convert markdown files into html files and then host these files on the github useraccount domain.
